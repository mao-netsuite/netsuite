...
define([
    ...
    var CUSTOM_LIST_EI_STATUS = "customlist_psg_ei_status";
    var ENTITY = "entity";
    ...
    var SENT = "7";
    var CANCELLED = "17";
    var REQUEST_COMPLETED = "val_ei_status_request_completed";
    var SYSTEM_USER = -4;
    ...
    function beforeLoad(context) {
        ...
        if (isUI) {
            ...
            if (
                ...
                bannerMessage = licenseManager.licenseCheckShowBanner(
                    subsidiaryId,
                    isAvalara &&
    ...
    function isValidStatusForGenerateButton(eiStatus, certIsOn, isAvalara) {
    ...
    function isValidStatusForGeneration(eiStatus) {
        var VALID_STATUSES_FOR_GENERATE = [FOR_GENERATION, GENERATION_FAILED];
    ...
    function shouldEiStatusBeResetOnTransactionModification(
        ...
        var requestCompletedInternalId = eiUtils.getInternalIdUsingScriptId(
            CUSTOM_LIST_EI_STATUS,
            REQUEST_COMPLETED
        );
    ...
    function beforeSubmit(context) {
        ...
        if (context.type !== context.UserEventType.DELETE) {
            ...
            var entityField = transactionMap.getEntityFieldIDFromTransactionRecord(currRecord)           
